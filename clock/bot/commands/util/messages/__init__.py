...
from clock.bot.commands.util.messages.privacy import PrivacyMessageBuilder
...
def privacy(bot_user: ApiObject):
    return PrivacyMessageBuilder(bot_user).get_message()
